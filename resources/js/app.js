...
function fetchData(country) {
  ...
  const api_fetch = async (country) => {
    await fetch(
      "https://covid-193.p.rapidapi.com/statistics" + country + "/status/confirmed",
      requestOptions
    )
      .then((res) => {
        return res.json();
    ...
    await fetch(
      "https://covid-193.p.rapidapi.com/statistics" + country + "/status/recovered",
      requestOptions
    )
      .then((res) => {
        return res.json();
    ...
    await fetch(
      "https://covid-193.p.rapidapi.com/statistics" + country + "/status/deaths",
      requestOptions
    )
      .then((res) => {
        return res.json();
